...
<h2 align="center">Amount-deposit</h2>
</div>
<div class="vertical-center">
<form action="AmountDepositController" method="post" onsubmit ="return operationvalidate()">
...
<tr><td> <input type="submit" value="Deposit" class="alert alert-danger" >
