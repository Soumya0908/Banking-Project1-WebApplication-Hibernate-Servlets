...
<form action="AuthenticateUser" method="post" onsubmit="return validate()" >
<table cellpadding="10" cellspacing="10">
<tr><td>CustomerAccNo </td><td><input type="text" name="customerAccNo" id="customerAccNo" /></td></tr>
...
<a href="CustomerSignUp.html">CREATE-ACCOUNT</a>
